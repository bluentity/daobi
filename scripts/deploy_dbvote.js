...
async function main() {
  // const Contract = await ethers.getContractFactory("DaobiVoteContract", {
  //   path: "contracts/src/DaobiVoteContract2.sol"
  // });  
  const Contract = await ethers.getContractFactory("./contracts/src/DaobiVoteContract2.sol:DaobiVoteContract");
